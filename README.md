...
6. Double-click the app file or open the included local web file in your browser.
...
3. Use the latest version of Chrome or Edge.
4. Set your display to full screen if you want a wider view.
5. If the planet loads slowly, wait for the scene to finish building before moving around.
...
- `.html` — a browser file that you can open in your web browser
- `.json` — a config file that the app may use in the background
